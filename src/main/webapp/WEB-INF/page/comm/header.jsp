		...
		<div class="carousel-inner">
			<div class="item active">
				<a href="${base}/book/detail?id=1"><img
					src="${base}/images/book1_nav.jpg" class="pull-left"
					alt="First slide"></a> <a href="${base}/book/detail?id=1"><img
					src="${base}/images/book2_nav.jpg" class="pull-left"
					alt="First slide"></a> <a href="${base}/book/detail?id=1"><img
					src="${base}/images/book3_nav.jpg" alt="Third slide"></a>

			</div>
			<div class="item">
				<a href="${base}/book/detail?id=2"><img
					src="${base}/images/book4_nav.jpg" class="pull-left"
					alt="First slide"></a> <a href="${base}/book/detail?id=2"><img
					src="${base}/images/book5_nav.jpg" class="pull-left"
					alt="First slide"></a> <a href="${base}/book/detail?id=2"><img
					src="${base}/images/book6_nav.jpg" alt="Third slide"></a>
			</div>
			<div class="item">
				<a href="${base}/book/detail?id=3"><img
					src="${base}/images/book7_nav.jpg" class="pull-left"
					alt="First slide"></a> <a href="${base}/book/detail?id=3"><img
					src="${base}/images/book8_nav.jpg" class="pull-left"
					alt="First slide"></a> <a href="${base}/book/detail?id=3"><img
					src="${base}/images/book9_nav.jpg" alt="Third slide"></a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<!--登录的form表单-->
				<form id="form2" class="form-horizontal" role="form" action="">
					<div class="form-group has-feedback">
						<label for="loginName" class="col-sm-2 control-label">用户名</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" id="loginName"
								value="${name}" name="username" placeholder="请输入用户名"> <span
					...
					<div class="form-group has-feedback">
						...
						<div class="col-sm-5">
							<input type="password" class="form-control" value="${password}"
								id="loginPassword" name="password" placeholder="请输入密码"> <span
					...
					<div class="modal-footer">
						...
						<input type="submit" onclick="login()" class="btn btn-primary"
							value="登录">
					</div>
				</form>
				<!--form结束-->
...
<div class="modal fade" id="register" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<!--注册的form表单-->
				<form id="form1" action="${base}/user/register" class="form-horizontal"
					...
					<div class="form-group has-feedback">
						...
						<div class="col-sm-3" style="padding-top: 10px;">
							<label id="regPasswordHint1"></label>
						</div>
					...
					<div class="form-group has-feedback">
						...
						<div class="col-sm-5">
							<input type="password" name="repassword" class="form-control" id="regPassword2"
								required  min="6" maxlength="8"
...
<script type="text/javascript">
	...
	/* function onPassword() {
		if(regPassword.value.length<6 || regPassword.value.length>8){
			rightPassword = false;
			regPassword.value="";
			regPasswordHint1.innerHTML = "<b style='color:red'>密码长度有误，请重新输入</b>";
		}else {
			rightPassword = true;
			regPasswordHint1.innerHTML = "<b style='color:green'>OK</b>"
		}
	}
	function checkPassword() {
		if (regPassword2.value == regPassword.value) {
			...
			rightPassword = true;
			regPasswordHint.innerHTML = "<b style='color:green'>OK</b>"
		} else {
			rightPassword = false;
			regPassword2.value = "";
		...
		xmlhttp.onreadystatechange = function() {
			...
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				if (xmlhttp.responseText == 1) {
					rightName = true;
					regHint.innerHTML = "<b style='color:green'>OK</b>"
				} else {
					rightName = false;
					regHint.innerHTML = "<b style='color:red'>用户名已存在</b>"
				}
			}
		};
		//3.设置AJAX请求

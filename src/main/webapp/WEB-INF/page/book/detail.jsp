...
<body>
					...
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<div style="clear: both;">
								...
								</a> <a href="javascript:addCart(${bk.bookid},false)" class="btn btn-default" role="button">
	...
	<script type="text/javascript">
		...
		function addCart(id,immite){
			...
			$.get("${base}/permission/cart/addCart?id="+id+"&count="+count,function(data,status){
				if(status=='success'){
					...
					if(data==1){
						...
						if(immite){
							...
							$("#rightData").load("${base}/book/right");
						}
					}else if(data==3){
						alert("请输入正确的购买数量");
					}else{
